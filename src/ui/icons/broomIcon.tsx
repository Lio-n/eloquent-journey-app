...
const BroomIcon = ({ style, className }: { style?: CSSProperties; className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ ...style, width: "1.5rem" }} className={className}>
